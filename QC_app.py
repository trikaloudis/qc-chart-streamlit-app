...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        # Replace the URL with the actual URL of your logo image
        logo_url = "https://placehold.co/200x100/FFFFFF/000000?text=Your+Lab+Logo"
        st.image(logo_url, use_container_width=True)
        st.markdown(
            "<div style='text-align: center;'><b><a href='https://www.aquomixlab.com/'>AQUOMIX LAB</a></b></div>",
